...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bold-rice-ee6b
```

A live public deployment of this template is available at [https://bold-rice-ee6b.templates.workers.dev](https://bold-rice-ee6b.templates.workers.dev)
